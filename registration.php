    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Electronicos ITAT</small></h1>
            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-mobile" aria-hidden="true"></i>&nbsp; Ingrese su número telefonico</label>
                              ...
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-map-marker"></i>&nbsp; Ingrese su codigo postal #</label>

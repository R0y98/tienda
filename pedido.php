    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">Electronicos ITAT</small></h1>
            </div>
            <br><br><br>
            <div class="row">
            ...
            <p>
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="Cedclien" placeholder="Telefono del cliente" maxlength="15" required="">
                </div>
                <div class="form-group">
